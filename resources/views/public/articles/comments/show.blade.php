    ...
    <div class="comment">
        ...
        <div class="comment_footer">
            <div class="comment_action">
                <span>
                    <a href="{{ route('public.comment.like',['comment' => $comment->id]) }}" class="text-primary like" title="Like">
                ...
                <span>
                    <a href="{{ route('public.comment.dislike',['comment' => $comment->id]) }}" class="text-danger dislike" title="Dislike">
